$(document).ready(function(){
    ...
    createTypedAnimation(".typing-2", ["Candidata a la Presidencia"], 20, 10, 6300, false);
    createTypedAnimation(".typing-3", ["Municipal de Guanajuato"], 30, 15, 8000, false);
    ...
    createTypedAnimation(".typing-7", ["a la Presidencia"], 45, 20, 3000, true); 
    createTypedAnimation(".typing-7-a", ["Municipal de Guanajuato"], 45, 20, 3500, true); 
    ...
    createTypedAnimation(".typing-13", ["La Transformación"], 80, 40, 700, false);
    createTypedAnimation(".typing-14", ["En Guanajuato Capital"], 50, 30, 1300, false);
    // createTypedAnimation(".typing-15", ["Mis Galerías"], 65, 45, 500, false);
    createTypedAnimation(".typing-16", ["'Paloma'"], 65, 40, 1000, false);
    createTypedAnimation(".typing-17", ["'El apoyo'"], 65, 40, 1000, false);
