...
function sharerbox(options) {
	...
	let DefaultsocialNetworks = 'facebook, whatsapp';
	...
	// Setting URLs for supported social-media sharing links
		...
		var facebookURL = `https://www.facebook.com/paloma.robles.l/`;
		...
		var whatsappURL = `https://wa.me/5214736524450?text=Este%20es%20mi%20whatsapp,%20contáctame
		`;
		...
		//Email
		var sendEmailURL = `mailto:regidorapalomagto@gmail.com?subject=Paloma, me interesa contactarte`;
